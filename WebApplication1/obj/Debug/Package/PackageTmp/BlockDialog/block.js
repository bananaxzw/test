...
; (function ($) {
    ...
    var mode = document.documentMode || 0; //除ie8以外的任何浏览器上返回的值是undefined.
    ...
    function install(el, opts) {
        var full = (el == window); //是页面遮罩还是局部的元素遮罩
        ...
        //移除页面用于遮罩层的内容元素 用blockUI.history 数据缓存起来
            ...
            $.each([lyr1, lyr2, lyr3], function (i, o) {
                ...
                if (i < 2) {
                    ...
                    if (full) {
                        ...
                        var top=(document.documentElement.clientHeight || document.body.clientHeight) / 2 - (this.offsetHeight / 2) + (blah = document.documentElement.scrollTop ? document.documentElement.scrollTop : document.body.scrollTop);
                    }
                    s.marginTop = 0;
                }
        ...
        //            var cb2 = msg ? cb : noOp;
        //            if (opts.showOverlay)
        //                lyr2._fadeIn(opts.fadeIn, cb1);//渐变进入
        //            if (msg)
