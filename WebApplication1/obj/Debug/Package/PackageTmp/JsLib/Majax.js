...
Sys._ScriptLoader.prototype = {
	...
	notifyScriptLoaded: function() {
		...
		if (Sys.Browser.agent === Sys.Browser.Safari) if (this._currentTask._notified === 1) window.setTimeout(Function.createDelegate(this,
		function() {
...
Sys.Services._RoleService.prototype = {
	...
	load: function(a, b, c) {
		Sys.Net.WebServiceProxy.invoke(this._get_path(), "GetRolesForCurrentUser", false, {},
		Function.createDelegate(this, this._onLoadComplete), Function.createDelegate(this, this._onLoadFailed), [a, b, c], this.get_timeout())
	},
	_get_path: function() {
		var a = this.get_path();
...
Sys.Serialization.JavaScriptSerializer._escapeRegEx = new RegExp('["\\\\\-\]', "i");
Sys.Serialization.JavaScriptSerializer._escapeRegExGlobal = new RegExp('["\\\\\-\]', "g");
...
Sys.Serialization.JavaScriptSerializer._serializeStringWithBuilder = function(a, c) {
	...
	if (Sys.Serialization.JavaScriptSerializer._escapeRegEx.test(a)) {
		...
		if (a.length < 128) a = a.replace(Sys.Serialization.JavaScriptSerializer._escapeRegExGlobal,
		function(a) {
